...
md_gov_county <- md_gov_county |>
  mutate(total = cox + moore +lashar + wallace + harding, pct_moore = (moore/total)*100 )
write_csv(md_gov_county, "data/md_gov_county_expanded.csv")
```
...
https://datawrapper.dwcdn.net/CB12o/1/ 