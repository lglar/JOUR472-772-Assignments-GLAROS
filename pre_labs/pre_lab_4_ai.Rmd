...
```{r}
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
```{r}
groq_response <- axolotr::ask(
  prompt = "What is the most common error in R",
  model = "llama-3.1-8b-instant"
)
...
**Your comment:** It makes sense because the first error listed, missing parentheses, is something I have encountered a lot.
