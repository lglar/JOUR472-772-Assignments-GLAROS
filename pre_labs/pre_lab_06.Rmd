...
```{r}
county_voters_2016 <- read_csv("data/county_voters_2016.csv") |> clean_names()
county_voters_2018 <- read_csv("data/county_voters_2018.csv") |> clean_names()
county_voters_2020 <- read_csv("data/county_voters_2020.csv") |> clean_names()
county_voters_2022 <- read_csv("data/county_voters_2022.csv") |> clean_names()
```
...
```{r}
maryland_population <- read_csv('data/maryland_population_2020.csv') |> clean_names()
```
...
```{r}
maryland_demographics <- read_csv('data/maryland_demographics.csv') |> clean_names()
```
