...
maryland_expenses |>
  ...
  group_by(month) |>summarise(total_amount = sum(amount)) |>
...
1.  How many expenditures were over \$10,000? (this would use the filter function)

2.  What percentage of all courses taught are from each department? (would use mutate function)

3.  Which classes have more than 3 sections? (this would use the filter function)
