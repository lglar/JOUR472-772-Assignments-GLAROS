...
**Task** What is another question you could ask of this data? also try with code**Answer**
What school has the highest percentage amount of high school graduates enrolled in college? Eastern Technical High School
```{r}
md_high_schools_with_acs |>
group_by(school, percent_of_high_school_graduates_enrolled) |>
summarize(percent_of_high_school_graduates_enrolled_count=n()) |>
arrange(desc(percent_of_high_school_graduates_enrolled))
```
